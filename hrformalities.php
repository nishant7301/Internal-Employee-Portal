...
<html>
<head>
<title>HR formalities for Fresher</title>
   <meta charset="utf-8">
...
if ($_SERVER['REQUEST_METHOD']=="POST"){
   ...
   // we'll just plug them a variable to be used later
      $frommail = "nishant@maxonic.com";
	      ...
	      $from = $email."<".stripslashes($frommail).">";
...
<div class="col-sm-4">
<a class="btn active" href="hrformalities.php">For Freshers</a>
<a   href="hrformalities1.php">For Experienced</a> 
</div>
...
<input type="file" name="file8" accept="image/*" required><br>
